...
namespace MehrIt\OttoQuantitiesApiClient\Api;
...
use MehrIt\OttoQuantitiesApiClient\HeaderSelector;
...
class AvailableQuantityApi
{
     ...
     *
     * @param  \MehrIt\OttoQuantitiesApiClient\Model\AvailableQuantityRequestDTOV2[] $body availableQuantityRequestDTO (required)
     *
     * @throws \MehrIt\OttoQuantitiesApiClient\ApiException on non-2xx response
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoQuantitiesApiClient\Model\UpdateQuantityMultiStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 413:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoQuantitiesApiClient\Model\ApiErrorResponseV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
